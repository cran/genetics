# $Id: genotype.R,v 1.20 2002/11/12 19:59:24 warnesgr Exp $
#
# $Log: genotype.R,v $
...
#
#
# Added classes to handle Hardy-Wienburg Equilibrium for several markers
# (marker.freq object) and made other minor display changes.
#
# Revision 1.2  2001/02/06 17:02:06  warneg
#
#
# Added Hardy-Weinburg Equilibrium test function (HWE.test.allele.freq).
